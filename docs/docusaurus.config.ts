...
const config: Config = {
  ...
  customFields: {
    apiUrl: process.env.REACT_APP_API_URL || 'https://hackathon-physical-ai-robotics-production.up.railway.app/api',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/MOrhan786?tab=repositories',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/MOrhan786?tab=repositories',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Mrs Asif GitHub',
              href: 'https://github.com/MOrhan786?tab=repositories',
            },
            {
              label: 'LinkedIn',
                href: 'https://www.linkedin.com/in/razia-fatima-041290329/',
            },
          ],
        },
        {
